...
var _ = Describe("func DeriveKey()", func() {
	It("derives the key using NIST SP 800-56C", func() {
		var (
			inputKey = []byte{0x6e, 0xe6, 0xc0, 0x0d, 0x70, 0xa6, 0xcd, 0x14, 0xbd, 0x5a, 0x4e, 0x8f, 0xcf, 0xec, 0x83, 0x86}
			...
			expected = []byte{0x13, 0x47, 0x9e, 0x9a, 0x91, 0xdd, 0x20, 0xfd, 0xd7, 0x57, 0xd6, 0x8f, 0xfe, 0x88, 0x69, 0xfb}
		)
